...
export const validateRegistration = [
    ...
    body('username')
        ...
        .custom(async (username) => {
            // Llama al método UserExist de la instancia de AuthService
            const userExists = await AuthService.UserExist(username);
            if (userExists) {
                // Si el usuario existe, lanza un error que express-validator capturará
...
export const validateLogin = [
    body('username')
        ...
        .custom(async (username) => {
            ...
            // Si el usuario existe, lanza un error que express-validator capturará
            throw new Error('Nombre de usuario no registrado.');
        }),
